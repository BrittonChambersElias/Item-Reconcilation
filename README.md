# Item Reconcilation
A graphical user interface allowing on-site support and operators the ability to perform a complete item reconcilation within one applicaiton.
...
## Scan an Item
- `Scan item` device to find systematically correct envelope and master carton location.   
...
Second, select `Scan an Item`, and scan either a item, envelope, or master carton
